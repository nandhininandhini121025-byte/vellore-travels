...
<li><img src="images/menu-spilit.png" alt="menu" /></li>
<li class="current2"><a href="tourist-places.php" rel="ddsubmenu1">Tourist Places</a></li>
<li><img src="images/menu-spilit.png" alt="menu" /></li>
<li class="current3"><a href="#" rel="ddsubmenu2">City Directory</a></li>
<li><img src="images/menu-spilit.png" alt="menu" /></li>
<li class="current7"><a href="online_booking.php">Online Booking</a></li>
<li><img src="images/menu-spilit.png" alt="menu" /></li>
<li class="current10"><a href="contactus.php">Contact Us</a></li>
</ul>
</div>
